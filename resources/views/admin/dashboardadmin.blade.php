...
<nav class="navbar navbar-expand-lg">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item"><a class="nav-link" href="{{ route('admin.requestadmin') }}">Request Post</a></li>
            <li class="nav-item">
                    <a class="nav-link" href="{{ route('user.aboutus') }}">AboutUs</a>
                </li>
            <!-- <li class="nav-item"><a class="nav-link" href="{{ route('user.login') }}" style="margin-left: 1000px;">Login</a></li> -->
        </ul>
