...
<div class="container">
    ...
    <form method="POST" action="{{ route('admin.check') }}">
        ...
        <a href="{{ route('user.login') }}" class="admin-link" style="float: left;">You Want to Login as User ?</a>
        <a href="{{ route('reviewer.loginreviewer') }}" class="admin-link" style="float: left;">You Want to Login as reviewer ?</a>
