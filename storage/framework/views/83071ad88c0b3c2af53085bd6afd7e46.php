        ...
        <div class="container">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    <?php if(isset($LoggedUser) && $LoggedUser->posts->count() > 0): ?>
                        <?php $__currentLoopData = $LoggedUser->posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><?php echo e(Str::limit($post->content, 1000)); ?></td>
                                <td>
                                ...
                                <td>
                                    <?php if($post->suggestion): ?>
                                        <span class="text-info"><?php echo e($post->suggestion); ?></span>
                                    <?php else: ?>
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="5" class="text-center">You don't have any posts yet.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
...
<?php /**PATH C:\Users\Purvarajsinh\OneDrive\Desktop\COLLEGE WORK\SEM-4\Laravel\Project\Blog-Management\resources\views/user/dashboard.blade.php ENDPATH**/ ?>