...
<div class="container">
    ...
    <form method="POST" action="<?php echo e(route('admin.check')); ?>">
        <?php echo csrf_field(); ?>
        ...
        <a href="<?php echo e(route('reviewer.loginreviewer')); ?>" class="admin-link" style="float: left;">You Want to Login as reviewer ?</a>
...
<?php /**PATH C:\Users\Purvarajsinh\OneDrive\Desktop\COLLEGE WORK\SEM-4\Laravel\Project\Blog-Management\resources\views/admin/loginadmin.blade.php ENDPATH**/ ?>